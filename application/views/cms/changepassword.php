...
<html>
  <head>
    ...
    <title>ALL ABOUT FASHION| Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#em"><b>All About </b>FASHION</a>
      </div><!-- /.login-logo -->
        ...
        <?=form_open("login/changepassword");?>
          ...
          <div class="row">
            ...
            <div class="btn-group  btn-block">
              ...
              <button type="submit" name="changepassword" onclick="confirm(' Are you sure you want to change password? ')" value="i" class="btn btn-primary">Change Password</button>
            </div><!-- /.col -->
          </div>
        </form>
